...
def paragraph(children, style_id=None, style_name=None, numbering=None, list_id=None, num_id=None, start_override=None, alignment=None, indent=None):
    if indent is None:
        indent = paragraph_indent()

    return Paragraph(children, style_id, style_name, numbering, list_id=list_id, num_id=num_id, start_override=start_override, alignment=alignment, indent=indent)
