...
def test_letter_list_following_numbered_list_stays_a_separate_letter_list():
    ...
    assert_equal(
        '<ol><li>Question</li></ol><ol type="a"><li>First</li><li>Second</li></ol>',
        result.value)
...
def test_highlight_runs_are_wrapped_in_span_tags():
    result = convert_document_element_to_html(
        documents.run(
